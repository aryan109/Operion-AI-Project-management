...
/**
 * Operion Claude Desktop Extension Runner
 * Relays JSON-RPC between Claude Desktop and Operion Cloud MCP server.
 */
...
rl.on("line", async (line) => {
  ...
  try {
    ...
    process.stderr.write(`[operion-claude-bridge] Error: ${err.message}\n`);
  }
});
